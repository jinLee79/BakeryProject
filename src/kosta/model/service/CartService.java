...
/*		//Hashtable : key, value 형식으로 데이터를 처리
		private Hashtable<String,OrderBean> hCart = new 

Hashtable<String,OrderBean>();
		...
		public void addCart(OrderBean obean){
			...
			if(quantity >0){ 
				...
				if(hCart.containsKey(product_no)){
					...
					OrderBean tempBean = (OrderBean)hCart.get
...
(tempBean.getQuantity());

					//기존상품 갯수 = 현재갯수 + 기존상품 갯수
					tempBean.setQuantity(Integer.toString
